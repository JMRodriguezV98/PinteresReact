...
const HeaderLayout = () => {
  return(
    <div style = {_headerStyle.headerLayoutS}>
      <div style={{..._headerStyle.logo }}>
        <svg class="gUZ lZJ U9O kVc" height="24" width="24" fill='red'viewBox="0 0 24 24" aria-hidden="true" aria-label="" role="img">
      ...
      <div style={{..._headerStyle.text }}>
        <span>Inicio</span>
      </div>
      <div style={{..._headerStyle.text }}>
        <span>Hoy</span>
      </div>
      <div style={{..._headerStyle.find }}>
        <input type="text" placeholder="Buscar" style={{..._headerStyle.searchBar }}/>
      </div>
      <div style={{..._headerStyle.icons }}>
      ...
      <div style={{..._headerStyle.icons }}>
        <svg class="perfil" height="32" viewBox="0 0 512 512" width="32" xmlns="http://www.w3.org/2000/svg">
